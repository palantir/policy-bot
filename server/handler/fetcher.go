...
func (cf *ConfigFetcher) ConfigForPR(ctx context.Context, prctx pull.Context, client *github.Client) FetchedConfig {
	...
	return cf.configForPRRef(ctx, prctx, client, base)
}

func (cf *ConfigFetcher) ConfigForPRHead(ctx context.Context, prctx pull.Context, client *github.Client) FetchedConfig {
	head := prctx.HeadSHA()
	return cf.configForPRRef(ctx, prctx, client, head)
}

func (cf *ConfigFetcher) configForPRRef(ctx context.Context, prctx pull.Context, client *github.Client, ref string) FetchedConfig {
